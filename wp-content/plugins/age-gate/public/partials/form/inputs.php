<ol class="age-gate-form-elements">
  ...
  <li class="age-gate-form-section">
    ...
    <input type="text" name="age_gate[y]" class="age-gate-input" id="age-gate-y" value="<?php echo(isset($age['y']) ? esc_html($age['y']) : '') ?>" placeholder="<?php _e('YYYY', 'age-gate'); ?>" tabindex="1" required minlength="4" maxlength="4" pattern="[0-9]*" inputmode="numeric" autocomplete="off"<?php echo(isset($age['atts']['y']) ? esc_html($age['atts']['y']) : '') ?>>
  </li>
</ol>
