  ...
  <form class="custom-form-fields" action="admin-post.php" method="post">
    ...
    <table class="form-table">
      <tbody>
        ...
        <tr>
          <th scope="row"><label for="wp_age_gate_aria_label"><?php _e("Aria label", 'age-gate') ;?></label></th>
          <td>
            <?php if (!$this->settings['advanced']['use_js']): ?>
              <?php _e("Only applicable in JavaScript mode", 'age-gate'); ?>

              <?php $this->render_language_input('aria_label', $values, 'settings', 'hidden'); ?>
            <?php else: ?>
              <?php $this->render_language_input('aria_label', $values); ?>
            <?php endif; ?>
          </td>
        </tr>
        <tr>
    ...
    <table class="form-table">
      <tbody>
        <tr>
          <th scope="row">
            <label for="wp_age_gate_date"><?php _e("Invalid date message", 'age-gate'); ?></label>
          </th>
          <td>
            <?php $this->render_language_input('validate_date', $validation, 'validation'); ?>
          </td>
        </tr>
        <tr>
          <th scope="row">
