...
<div class="wrap">
    ...
    <form class="custom-form-fields" action="admin-post.php" method="post">
        ...
        $values['use_js']
                ...
                <tr class="ep" <?php echo(!$values['use_js'] ? ' style="display: none;"' : '') ?>>
                    <th scope="row"><?php _e('Disable right click and F12', 'age-gate'); ?></th>
                    <td>
                        <label class="ag-switch">
                            <?php echo form_checkbox(
                                array(
                                    'name' => 'ag_settings[disable_right]',
                                    'id' => 'wp_age_gate_disable_right'
                                ),
                                1,
                                $values['disable_right']
                            ); ?><span class="ag-switch__slider"></span>
                        </label> <label><?php echo __('Removes users ability to open context menu or dev tools with F12. Other routes may stil be available for developers', 'age-gate') ?></label>

                    </td>

                </tr>
                <tr>
                    <th scope="row"><?php _e('Preload images', 'age-gate'); ?></th>
                    <td>
                        <label class="ag-switch">
                            <?php echo form_checkbox(
                                array(
                                    'name' => 'ag_settings[preload_images]',
                                    'id' => 'wp_age_gate_preload_images'
                                ),
                                1,
                                $values['preload_images']
                            ); ?><span class="ag-switch__slider"></span>
                        </label> <label><?php echo __('Preload any background or logo images in use for Age Gate', 'age-gate') ?></label>
